...
func validate(conditional:Array) -> void: 
    ...
    match len_state:
        3:
            ...
            assert(conditional[1] is compare_operator, "Invalid arg type: for len(Array) = 3 array[1] must be of type compare_operator. Got: " + str(typeof(conditional[1])))
            ...
            _type_statement = 0.0
        4:
            var type_of_param_0 = typeof(conditional[0])
            var type_of_param_2 = typeof(conditional[2])
            assert(type_of_param_0 == logical_operator.NOT or type_of_param_2 == logical_operator.NOT, "Invalid arg type: for len(Array) = 4 array[0] or array[2] must be of type logical_operator.NOT. Got: typeof(conditional[0])) = " + str(typeof(conditional[0])) + ", typeof(conditional[2]) = " + str(typeof(conditional[2])) )

            if type_of_param_0 == logical_operator.NOT:
                ...
                assert(conditional[2] is compare_operator, "Invalid arg type: for len(Array) = 4, where array[0] is NOT, array[2] must be of type compare_operator. Got: " + str(typeof(conditional[2])))
                ...
                assert(conditional[1] is compare_operator, "Invalid arg type: for len(Array) = 4, where array[2] is NOT, array[1] must be of type compare_operator. Got: " + str(typeof(conditional[1])))
        ...
        5:
            var type_of_param_0 = typeof(conditional[0])
            var type_of_param_3 = typeof(conditional[3])
            assert(type_of_param_0 == logical_operator.NOT and type_of_param_3 == logical_operator.NOT, "Invalid arg type: for len(Array) = 5 array[0] and array[3] must be of type logical_operator.NOT. Got: typeof(conditional[0])) = " + str(typeof(conditional[0])) + ", typeof(conditional[3]) = " + str(typeof(conditional[3])) )
            ...
            assert(conditional[2] is compare_operator, "Invalid arg type: for len(Array) = 5, array[2] must be of type compare_operator. Got: " + str(typeof(conditional[2])))
